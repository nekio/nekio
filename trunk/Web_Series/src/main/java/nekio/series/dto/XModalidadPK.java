 ...
 */
@Embeddable
public class XModalidadPK implements Serializable {
    ...
    public XModalidadPK(int appDebug, int appDesign, int bitacoraEstilo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof XModalidadPK)) {
            return false;
        }
        XModalidadPK other = (XModalidadPK) object;
    ...
    public String toString() {
        return "nekio.series.dto.XModalidadPK[ appDebug=" + appDebug + ", appDesign=" + appDesign + ", bitacoraEstilo=" + bitacoraEstilo + " ]";
    }
