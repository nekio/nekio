package nekio.tools.converter;

import nekio.tools.dto.Imagen;
import nekio.tools.facade.ImagenFacade;
...
@FacesConverter(value = "imagenConverter")
public class ImagenConverter implements Converter {

    @Inject
    private ImagenFacade ejbFacade;
